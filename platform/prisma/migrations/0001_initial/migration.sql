-- Baseline migration for the Phase 1 platform schema.
-- This migration creates the original schema that 0002_phase1_production_hardening
-- extends. It is intentionally additive-only and must run first on a fresh database.
...
ALTER TABLE "Constituency"
  ADD CONSTRAINT "Constituency_stateId_fkey"
  FOREIGN KEY ("stateId") REFERENCES "State"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "ConstituencyVersion"
  ADD CONSTRAINT "ConstituencyVersion_constituencyId_fkey"
  FOREIGN KEY ("constituencyId") REFERENCES "Constituency"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "ConstituencyVersion"
  ADD CONSTRAINT "ConstituencyVersion_electionId_fkey"
  FOREIGN KEY ("electionId") REFERENCES "Election"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "CandidateResult"
  ADD CONSTRAINT "CandidateResult_electionId_fkey"
  FOREIGN KEY ("electionId") REFERENCES "Election"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "CandidateResult"
  ADD CONSTRAINT "CandidateResult_constituencyVersionId_fkey"
  FOREIGN KEY ("constituencyVersionId") REFERENCES "ConstituencyVersion"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "CandidateResult"
  ADD CONSTRAINT "CandidateResult_candidateId_fkey"
  FOREIGN KEY ("candidateId") REFERENCES "Candidate"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "CandidateResult"
  ADD CONSTRAINT "CandidateResult_partyId_fkey"
  FOREIGN KEY ("partyId") REFERENCES "Party"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "ConstituencyStatistic"
  ADD CONSTRAINT "ConstituencyStatistic_electionId_fkey"
  FOREIGN KEY ("electionId") REFERENCES "Election"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "ConstituencyStatistic"
  ADD CONSTRAINT "ConstituencyStatistic_constituencyVersionId_fkey"
  FOREIGN KEY ("constituencyVersionId") REFERENCES "ConstituencyVersion"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "ResultSource"
  ADD CONSTRAINT "ResultSource_resultId_fkey"
  FOREIGN KEY ("resultId") REFERENCES "CandidateResult"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "ResultSource"
  ADD CONSTRAINT "ResultSource_sourceId_fkey"
